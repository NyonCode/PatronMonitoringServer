    ...
    <div class="hidden lg:block bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700">
        <table class="w-full table-fixed">
            ...
            <tr>
                ...
                <th class="w-[18%] px-3 py-3 text-left"><span class="font-semibold text-sm text-zinc-700 dark:text-zinc-300">Disk</span></th>
                <th class="w-[7%] px-3 py-3 text-center"><span class="font-semibold text-sm text-zinc-700 dark:text-zinc-300">Akce</span></th>
            </tr>
            </thead>
                        ...
                        @if($disk)
                            <div class="space-y-1">
                                <div class="flex items-center justify-between gap-1">
                                    <span class="text-xs text-zinc-600 dark:text-zinc-400 truncate">{{ $disk['name'] }}</span>
                                ...
                                <div class="text-xs text-zinc-500 dark:text-zinc-400 truncate">{{ $disk['free'] }} free</div>
                            </div>
                        @else
    ...
    <div class="lg:hidden space-y-3">
        @forelse($this->agents as $agent)
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700 p-4"
                ...
                <!-- Expandable disk info - x-cloak zabraňuje probliknutí -->
                ...
                <!-- Secondary actions - x-if úplně odstraní z DOM dokud není potřeba -->
                <template x-if="showDetails">
