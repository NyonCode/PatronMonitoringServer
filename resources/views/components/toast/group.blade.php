    ...
    <template x-for="(toast, index) in toasts" :key="toast.id">
        ...
        >
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 pt-0.5">
                        <template x-if="toast.heading">
                            <p class="text-sm font-medium text-zinc-900 dark:text-zinc-100" x-text="toast.heading"></p>
                        </template>
                        <p
            ...
            <template x-if="toast.duration > 0">
                <div class="h-1 bg-zinc-100 dark:bg-zinc-700">
                    <div
...
<script>
    ...
    // Global Toast function (same as in toast.blade.php but included here for standalone use)
